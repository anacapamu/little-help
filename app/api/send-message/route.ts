...
import { doc, setDoc, getDocs, collection, query, where, addDoc, getDoc } from 'firebase/firestore';
...
async function handler(req: NextRequest) {
    ...
    try {
        ...
        return NextResponse.json({ success: true, messageId, conversationId, content, senderName, receiverName });
    } catch (error) {
